...
export default function DashboardClient({ subdomains }: { subdomains: Subdomain[] }) {
  ...
  function startEdit(sub: Subdomain) {
    ...
    setEditTxtValue(sub.vercelTxtValue ?? "");
    setEditError("");
  }
    ...
    try {
      ...
      if (!res.ok) {
        ...
        setList((prev) =>
          prev.map((s) =>
            s.id === sub.id
              ? { ...s, target: body.vercelTarget ?? s.target, vercelTxtValue: body.vercelTxtValue ?? s.vercelTxtValue }
              : s
          )
        );
        cancelEdit();
            ...
            {isEditing && (
              <div className="px-5 pb-5 pt-0 border-t border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950">
                <div className="pt-4 flex flex-col gap-4">
                  <p className="text-sm font-medium">▲ Update Vercel settings</p>
                  <div>
                ...
                <div className="pt-4 flex flex-col gap-3">
                  ...
                  {sub.type === "github_pages" ? (
                    ...
                    <ol className="text-sm text-zinc-600 dark:text-zinc-400 list-decimal list-inside flex flex-col gap-1.5">
                      ...
                      <li>If Vercel shows &quot;Verification Needed&quot;, click <strong>Edit</strong> above and paste the TXT value</li>
